...
def Hamestart():
    global Starteverything, player1, player2, player3, player4
    ...
    player4 = sprites.create(assets.image("""
        myImage3
        """), SpriteKind.player)
...
def Startscreen():
    global Starteverything, Maintext, myMenu
    scene.getIcon_block(scene.SystemMenuIcon.CARD_NORMAL).fill(0)
    scene.getIcon_block(scene.SystemMenuIcon.CARD_NORMAL).draw_transparent_image(img("""
        ...
        0,
        0)
    scene.getIcon_block(scene.SystemMenuIcon.CARD_SELECTED).fill(0)
    scene.getIcon_block(scene.SystemMenuIcon.CARD_SELECTED).draw_transparent_image(img("""
        ...
        0,
        0)
    scene.getIcon_block(scene.SystemMenuIcon.CARD_ACTIVE).fill(0)
    scene.getIcon_block(scene.SystemMenuIcon.CARD_ACTIVE).draw_transparent_image(img("""
        ...
        0,
        0)
    scene.getIcon_block(scene.SystemMenuIcon.VOLUME_DOWN).fill(0)
    scene.getIcon_block(scene.SystemMenuIcon.VOLUME_DOWN).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
        ...
        0,
        0)
    scene.getIcon_block(scene.SystemMenuIcon.VOLUME_UP).fill(0)
    scene.getIcon_block(scene.SystemMenuIcon.VOLUME_UP).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
    ...
    scene.getIcon_block(scene.SystemMenuIcon.STATS).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
    ...
    scene.getIcon_block(scene.SystemMenuIcon.CONSOLE).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
    ...
    scene.getIcon_block(scene.SystemMenuIcon.SLEEP).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
    ...
    scene.getIcon_block(scene.SystemMenuIcon.CLOSE).draw_transparent_image(img("""
            ................................
            ................................
            ................................
            ................................
    ...
    Maintext.set_kind(SpriteKind.Text)
    fancyText.set_color(Maintext, 8)
    fancyText.set_max_width(Maintext, 100)
    fancyText.set_font(Maintext, fancyText.geometric_serif_11)
    myMenu = miniMenu.create_menu(miniMenu.create_menu_item("Start!"),
        miniMenu.create_menu_item("Credits"))
    miniMenu.set_frame(myMenu,
        img("""
            ...
            . 6 6 6 6 6 6 6 6 6 . . . . .
            """))
    miniMenu.set_style_property(myMenu,
        miniMenu.StyleKind.SELECTED,
        miniMenu.StyleProperty.BACKGROUND,
        7)
    myMenu.set_position(122, 89)
    ...
    def on_button_pressed_a(selection, selectedIndex):
        if selection == "Start!":
            ...
            Credits()
    miniMenu.on_button_pressed(myMenu, miniMenu.Button.A, on_button_pressed_a)
...
def on_player4_life_zero():
    if Starteverything:
        ...
        if not (info.player1.has_life()) and (not (info.player2.has_life()) and not (info.player3.has_life())):
            ...
            game.show_long_text("They got big by " + str(info.player4.score()) + " points!",
                DialogLayout.BOTTOM)
            music.stop_all_sounds()
            game.over(True)
        else:
...
def on_player3_life_zero():
    if Starteverything:
        ...
        if not (info.player1.has_life()) and (not (info.player2.has_life()) and not (info.player4.has_life())):
            ...
            game.show_long_text("They got big by " + str(info.player3.score()) + " points!",
                DialogLayout.BOTTOM)
            music.stop_all_sounds()
            game.over(True)
        else:
...
def on_player4_button_a_pressed():
    ...
    if Starteverything:
        if info.player4.has_life():
            ...
            dart4 = sprites.create_projectile_from_sprite(assets.image("""
                myImage6
                """), player4, 200, 0)
            pause(100)
...
def Credits():
    global myTextSprite, myTextSprite2
    myTextSprite = fancyText.create("     ")
    myTextSprite2 = fancyText.create("     ")
    fancyText.set_text(myTextSprite, "Code and Art by RoboVacDev (and friends)")
    fancyText.set_text(myTextSprite2,
        "Songs by AbstractDesigner and InvalidProject")
    fancyText.set_max_width(myTextSprite, 100)
    fancyText.set_max_width(myTextSprite2, 100)
    myTextSprite.set_kind(SpriteKind.Text)
    myTextSprite2.set_kind(SpriteKind.Text)
    fancyText.set_font(myTextSprite2, fancyText.geometric_sans_6)
    fancyText.set_font(myTextSprite, fancyText.geometric_sans_6)
    myTextSprite.set_position(52, 28)
    myTextSprite2.set_position(52, 88)
    pause(2000)
...
def on_player1_life_zero():
    if Starteverything:
        ...
        if not (info.player2.has_life()) and (not (info.player3.has_life()) and not (info.player4.has_life())):
            ...
            game.show_long_text("They got big by " + str(info.player1.score()) + " points!",
                DialogLayout.BOTTOM)
            music.stop_all_sounds()
            game.over(True)
        else:
...
def on_player3_button_a_pressed():
    ...
    if Starteverything:
        if info.player3.has_life():
            ...
            dart3 = sprites.create_projectile_from_sprite(assets.image("""
                myImage5
                """), player3, 200, 0)
            pause(100)
...
def on_player2_life_zero():
    if Starteverything:
        ...
        if not (info.player1.has_life()) and (not (info.player3.has_life()) and not (info.player4.has_life())):
            ...
            game.show_long_text("They got big by " + str(info.player2.score()) + " points!",
                DialogLayout.BOTTOM)
            music.stop_all_sounds()
            game.over(True)
        else:
...
def on_on_overlap(sprite, otherSprite):
    if Starteverything:
        if sprite == dart1:
            ...
            def on_background7():
                player1.change_scale(0.5, ScaleAnchor.MIDDLE)
            ...
            def on_background8():
                player2.change_scale(0.5, ScaleAnchor.MIDDLE)
            ...
            def on_background9():
                player3.change_scale(0.5, ScaleAnchor.MIDDLE)
            ...
            def on_background10():
                player4.change_scale(0.5, ScaleAnchor.MIDDLE)
...
dart4: Sprite = None
myMenu: Sprite = None
Maintext: fancyText.TextSprite = None
dart2: Sprite = None
player4: Sprite = None
player3: Sprite = None
player2: Sprite = None
...
def on_update_interval():
    ...
    if Starteverything:
        if True:
            ...
            pass
game.on_update_interval(999, on_update_interval)
